...
{
	[InitializeOnLoad]
	public class WelcomeAA : EditorWindow 
	{
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		private const string ONLINE_DOC_URL = "https://docs.google.com/document/d/1_NbN9ePNhxyucwSh2YLwU1uUE-Xqra80VG5VrfBOk_o/edit?usp=sharing";
		private const string RATEUS_URL = "http://u3d.as/kkC";

		private const string NAME_OF_THE_GAME = "AA";
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
